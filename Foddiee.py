...
class admin:
    ...
    food_item_list={1:{'Name' : 'Spring Roll' , 'Quantity' : '2 piece' , 'Price' : 40 , 'Discount(%)' : 10 , "Stock" : 50},
                    2:{'Name' : 'Hakka Noodles' , 'Quantity' : '200gm' , 'Price' : 150 , 'Discount(%)' : 5 , "Stock" : 55}, 
                    3:{'Name' : 'Chocolate Truffle Cake' , 'Quantity' : '1 piece' , 'Price' : 50 , 'Discount(%)' : 2 ,
                       "Stock" : 25}, 
                    4:{'Name' : 'Black Current Ice Cream' , 'Quantity' : '2 scoop' , 'Price' : 65 , 'Discount(%)' : 2 , 
                       "Stock" : 250}, 
                    5:{'Name' : 'Chicken Burger' , 'Quantity' : '1' , 'Price' : 120 , 'Discount(%)' : 15 , "Stock" : 150}}
    ...
    def __init__(self):
            print("FODDIE-Food Ordering App")
    ...
    def add_fooditem(self):
        ...
        try:
            if self.admin_login == True:
                ...
                admin.food_item_list[self.food_id] = {"Name" : self.name , 'Quantity' : self.quantity , 'Price' : self.price , 
